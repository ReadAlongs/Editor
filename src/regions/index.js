...
export default class RegionsPlugin {
  ...
  enableDragSelection(params) {
    ...
    const eventDown = (e) => {
      ...
      if (
        this.wavesurfer.params.splitChannels &&
        this.wavesurfer.params.splitChannelsOptions.splitDragSelection
      ) {
        const y =
          (e.touches ? e.touches[0].clientY : e.clientY) - wrapperRect.top;
        const channelCount =
        ...
        const channelColors =
          this.wavesurfer.params.splitChannelsOptions.channelColors[channelIdx];
